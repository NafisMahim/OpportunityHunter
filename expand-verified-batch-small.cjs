...
// Smaller targeted batch for better performance
async function expandVerifiedBatchSmall() {
    console.log('=== EXPANDING WITH VERIFIED BATCH (SMALL) ===');
    
    const smallBatch = [
        // Top-tier STEM Programs (Verified URLs)
        {
        ...
        },
        {
            ...
            "description": "Intensive 39-day program in astrophysics and biochemistry. Students conduct original research projects while earning college credit.",
        ...
        },
        {
            ...
            "description": "Prestigious 6-week summer program for rising seniors with full scholarships. Deep engagement with original texts and intense discussions.",
        ...
        },
        {
            ...
            "description": "Global competition for high school students to submit business concepts for social good or innovative market solutions.",
        ...
        },
        {
            ...
            "description": "Premier arts education programs in music, theater, dance, creative writing, and visual arts with scholarships available.",
    ...
    console.log(`📊 Prepared ${smallBatch.length} high-quality verified opportunities for import`);
    ...
    try {
        const response = await fetch('http://localhost:5000/api/opportunities/import', {
            ...
            body: JSON.stringify({ opportunities: smallBatch })
        });
        ...
        if (response.ok) {
            ...
            // Save for records
            fs.writeFileSync('./verified-batch-small.json', JSON.stringify(smallBatch, null, 2));
            console.log('💾 Saved verified opportunities to verified-batch-small.json');
            
            // Progress tracking
            const totalImported = result.imported;
            console.log(`🔍 Successfully processed batch of ${totalImported} opportunities`);
